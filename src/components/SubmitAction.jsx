    ...
    <section id="submit" className="py-12">
      <div className="container mx-auto px-6">
        <div className="bg-white rounded-2xl shadow-sm ring-1 ring-slate-200 p-6">
          <h2 className="text-2xl font-bold text-slate-900">Submit a Sustainable Action</h2>
          <p className="text-slate-600 mt-1">Provide measurable details. You can attest it later.</p>
